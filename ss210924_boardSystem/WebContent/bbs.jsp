	...
	<div class="container">
		<div class="row">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				<thead> <!-- 테이블의 제목 -->
					<tr> <!-- 행(줄) -->
						<th style="backgroud-color: #eeeee; text-align: center">번호</th>
						<th style="backgroud-color: #eeeee; text-align: center">제목</th>
						<th style="backgroud-color: #eeeee; text-align: center">작성자</th>
						<th style="backgroud-color: #eeeee; text-align: center">작성일</th>
					</tr>
				</thead>
				<tbody>
					<%
